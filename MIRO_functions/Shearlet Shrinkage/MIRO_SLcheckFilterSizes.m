function [ directionalFilter,scalingFilter,waveletFilter,scalingFilter2,shearLevels ] = MIRO_SLcheckFilterSizes(rows,cols,shearLevels,directionalFilter,scalingFilter,waveletFilter,scalingFilter2)
%% Check filter sizes
